...
import { AppointmentService } from "../_services/appt.service";
...
describe('ViewAppointmentComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [HttpClientTestingModule, HttpModule, RouterTestingModule, FormsModule, ReactiveFormsModule, NgbModule]
  ...
  it("should be check fitness api", inject([HttpTestingController, AppointmentService], (httpMock: HttpTestingController, dataService: AppointmentService) => {
    component.ngOnInit();
